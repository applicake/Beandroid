...
public class UserModifyPropertiesActivity extends BeanstalkActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    GravatarDowloader.getInstance().download(user.getEmail(),
  ...
  protected Dialog onCreateDialog(int id) {
    ...
    retypedPasswordEditText = (EditText) dialog.findViewById(R.id.retypePasswordEditText);
      ...
      public void onClick(View v) {
        if (newPasswordEditText.getText().toString().length() >= 4) {
          if (!newPasswordEditText.getText().toString()
            ...
            dialog.cancel();
            new SendUserPasswordTask().execute(newPasswordEditText.getText().toString());
          }
    ...
    protected Integer doInBackground(Void... params) {
      ...
      try {
        String userModificationXml = xmlCreator.createUserPropertiesChangeXML(
            nameEditText.getText().toString().trim(), lastNameEditText.getText()
                .toString().trim(), emailEditText.getText().toString().trim(),
