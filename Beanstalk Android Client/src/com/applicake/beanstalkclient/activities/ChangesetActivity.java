...
public class ChangesetActivity extends BeanstalkActivity implements OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    footerRefreshButtonView = ((LayoutInflater) getApplicationContext().getSystemService(
        Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.comment_list_footer_refresh,
        commentList, false);
    ...
    newCommentBody = (EditText) footerCommentInputView.findViewById(R.id.newCommentBody);
  ...
  public class ParseCommentListTask extends AsyncTask<String, Void, ArrayList<Comment>> {
    ...
    protected ArrayList<Comment> doInBackground(String... params) {
      ...
      try {
        ...
        String commentsXml = HttpRetriever.getCommentsListForRevisionXML(prefs, repoId,
            revision, 1);
  ...
  public class SendCommentTask extends AsyncTask<String, Void, String> {
    ...
    @Override
    protected void onPreExecute() {
      progressDialog = ProgressDialog.show(mContext, "Please wait...", "sending comment");
