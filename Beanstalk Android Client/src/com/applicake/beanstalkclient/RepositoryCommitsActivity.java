...
public class RepositoryCommitsActivity extends BeanstalkActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int repoColorLabelNo = currentIntent.getIntExtra(Constants.REPOSITORY_COLOR_NO, 0);
		
		mContext = this;
		changesetArray = new ArrayList<Changeset>();
		changesetAdapter = new RepositoryChangesetAdapter(this, R.layout.repository_changeset_entry, changesetArray);
